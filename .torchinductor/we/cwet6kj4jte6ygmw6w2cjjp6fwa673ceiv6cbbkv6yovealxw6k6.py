...
# kernel path: /n/fs/similarity/open-r1/.torchinductor/uh/cuhqfkx3j5gc7yxda35lfkq45esic2nnr52kbw6d55zsjgdgfx42.py
...
@triton_heuristics.pointwise(
    size_hints={'x': 2048}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*i64', 'out_ptr0': '*i64', 'out_ptr1': '*i1', 'ks0': 'i32', 'ks1': 'i32', 'ks2': 'i32', 'ks3': 'i32', 'ks4': 'i32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=64, cc=86, major=8, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1536, warp_size=32), 'constants': {}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1, 2), 'tt.equal_to': ()}, 'cls': 'AttrsDescriptor'})]},
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 1946
    arg1_1 = rand_strided((1946, ), (1, ), device='cuda:0', dtype=torch.int64)
    arg2_1 = 0
    arg3_1 = 76032
    arg4_1 = 152064
    arg5_1 = 152064
