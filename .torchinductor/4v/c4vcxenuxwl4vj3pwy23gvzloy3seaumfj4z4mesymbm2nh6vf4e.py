...
# kernel path: /n/fs/similarity/open-r1/.torchinductor/jq/cjq2litasr42hvhhlznhe2i3il3s5dubkimdzinfofxs3pjyleg6.py
...
# kernel path: /n/fs/similarity/open-r1/.torchinductor/y7/cy7lhud2myn6qj2t2bzbc2ii3tn73rjcdyxpjly6epmpzo27r7xv.py
...
@triton_heuristics.pointwise(
    size_hints={'x': 1}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*i64', 'out_ptr0': '*i1', 'ks0': 'i32', 'ks1': 'i32', 'ks2': 'i32', 'ks3': 'i32', 'xnumel': 'i32'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=68, cc=75, major=7, regs_per_multiprocessor=65536, max_threads_per_multi_processor=1024, warp_size=32), 'constants': {'xnumel': 1}, 'configs': [AttrsDescriptor.from_dict({'arg_properties': {'tt.divisibility': (0, 1), 'tt.equal_to': (6,)}, 'cls': 'AttrsDescriptor'})]},
